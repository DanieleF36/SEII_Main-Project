...
exports.getActiveByStudentId = (studentId) => {
  ...
  const fetchActiveApplicationSQL = 'SELECT * FROM Application WHERE id_student = ? AND (status=1 OR status=0)';
  return new Promise((resolve, reject) => {
