...
function checkQuery(req) {
  ...
  if (
    !(
      ...
      !isNotConvertible(req.query.title)
    )
  ) {
  ...
  if (
    !(
      ...
      !Array.isArray(req.query.supervisor) ||
      !isNotConvertible(req.query.supervisor)
    )
  ) {
  ...
  if (
    !(
      !req.query.groups ||
      !Array.isArray(req.query.groups) ||
      !isNotConvertible(req.query.groups)
    )
  ) {
  ...
  if (
    !(
      !req.query.knowledge ||
      !Array.isArray(req.query.knowledge) ||
      !Array.isArray(req.query.title) ||
      !isNotConvertible(req.query.knowledge)
    )
  ) {
  ...
  if (
    !(
      ...
      !Array.isArray(req.query.expiration_date) ||
      !isNotConvertible(req.query.expiration_date)
    )
  ) {
  ...
  if (
    !(
      !req.query.cds ||
      !Array.isArray(req.query.cds) ||
      !isNotConvertible(req.query.cds)
    )
  ) {
  ...
  if (
    !(
      ...
      !Array.isArray(req.query.creation_date) ||
      !isNotConvertible(req.query.creation_date)
    )
  ) {
